...
export const TournamentInfoStep = forwardRef<HTMLDivElement, TournamentInfoStepProps>(
  function TournamentInfoStep({ name, setName, date, setDate }, ref) {
    return (
      <div ref={ref} className="space-y-8 max-w-md mx-auto">
