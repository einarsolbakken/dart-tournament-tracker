...
export const TournamentFormatStep = forwardRef<HTMLDivElement, TournamentFormatStepProps>(
  function TournamentFormatStep({ tournamentFormat, setTournamentFormat }, ref) {
    return (
      <div ref={ref} className="space-y-8 max-w-lg mx-auto">
